...
exports.register = function (server, options, next) {
    ...
    server.auth.scheme('bearer-access-token', function (server, options) {
        ...
        options.alternativeHeaderName = options.alternativeHeaderName || null;
        ...
        var scheme = {
            authenticate: function (request, reply) {
                ...
                if (!authorization && settings.alternativeHeaderName && req.headers[settings.alternativeHeaderName]) {
                    authorization = settings.alternativeHeaderName + ' ' + req.headers[settings.alternativeHeaderName];
                }
